...
// These are the names for the bits.
// Use these only with the bit() macro.
#define MPU6050_UC_SIG_COND_RESET MPU6050_D0
#define MPU6050_UC_I2C_MST_RESET  MPU6050_D1
#define MPU6050_UC_FIFO_RESET     MPU6050_D2
#define MPU6050_UC_I2C_IF_DIS     MPU6050_D4   // must be 0 for MPU-6050
#define MPU6050_UC_I2C_MST_EN     MPU6050_D5
#define MPU6050_UC_FIFO_EN        MPU6050_D6
